            ...
            <div class="col-lg-7 mb-lg-0 mb-4 col-sm-12">
                <div class="card z-index-2 h-100">
                    <div class="card-header pb-0 pt-3 bg-transparent">
                        <h6 class="text-capitalize">Riwayat Transaksi</h6>
                        <p class="text-sm mb-0">
                            <i class="fa fa-history text-success"></i>
                            <span class="font-weight-bold">Bulan Januari</span>
                        </p>
                    </div>
                    <div class="card-body p-3">
                        <table class="table table-responsive table-stripped">
                            ...
                            <tbody>
                                ...
                                @else
                                <tr>
                                    <td colspan="3">Belum ada transaksi bulan ini</td>
                                </tr>
                                @endif
                              ...
                              <div class="col">
                                ...
                                <div class="mb-3">
                                  ...
                                  <div>
                                    ...
                                    <hr>
                                    <a  href="users_delete/{{$users->id}}" class="dis btn btn-danger btn-block w-100"> Hapus Akun</a>
                                  </div>
                              </div>
