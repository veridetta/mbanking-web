            ...
            <div class="col-lg-7 mb-lg-0 mb-4 col-sm-12">
                <div class="card z-index-2 h-100">
                    <div class="card-header pb-0 pt-3 bg-transparent">
                        <h6 class="text-capitalize">Form Transfer</h6>
                        ...
                        <form id="form-debit">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control form-lg" id="card" name="card"/><a href="#" id="btn_check" onclick="card_check()" class="btn mb-0 btn-lg btn-block btn-warning" >Cek</a>
                                </div>
                            </div>
                            ...
                            <div class="card-body" id="result">
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr class="text-sm">
                                            <td>Nominal </td>
                                            <td class="text-success font-weight-bolder">: Rp 28.000</td>
                                        </tr>
                                        <tr class="text-sm">
                                            <td>Berita </td>
                                            <td>: Contoh</td>
