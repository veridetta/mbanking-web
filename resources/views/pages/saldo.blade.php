            ...
            <div class="col-lg-7 mb-lg-0 mb-4 col-sm-12">
                <div class="card z-index-2 h-100">
                    <div class="card-header pb-0 pt-3 bg-transparent">
                        <h6 class="text-capitalize">Form Isi Saldo</h6>
                        <p class="text-sm mb-0">
                            <i class="fa fa-history text-success"></i>
                            <span class="font-weight-bold">Silahkan lengkapi sebelum melakukan isi saldo</span>
                        </p>
                    </div>
                    <div class="card-body p-3">
                        <form id="form-debit">
                            ...
                            <div class="form-group">
                                ...
                                <input type="debit" class="dis form-control form-lg" id="debit" name="debit"/>
                            </div>
                            <div class="form-group">
                                <label for="nominal">Keterangan</label> 
                                <input type="text" value="Tambah Saldo" class="dis form-control form-lg" id="desc" name="desc" disabled/>
                            </div>
                            <div class="form-group">
                                <input id="btn_trans" class="dis form-control btn btn-dark" value="Tambah Saldo" />
                            </div>
                    </div>
                </div>
            </div>
